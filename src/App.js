...
function App() {
  ...
  return (
    <div className="App">
      <h2>Get the pagination page size in AG Grid - <a href="https://www.cluemediator.com" target="_blank">Clue Mediator</a></h2>
      <button className='btn-action' onClick={handleBtnAction}>Get Page Size</button>
